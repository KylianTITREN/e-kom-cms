...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'CGV, mentions l\u00E9gales, politique de confidentialit\u00E9, etc.';
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    description: 'Actualit\u00E9s et articles du site';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ageRestricted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    endOfSeries: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    isPromo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
